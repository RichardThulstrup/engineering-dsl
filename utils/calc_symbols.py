...
# Constants use explicit precision; this module is ordinary Python.
from .sigfig import exact, measured
...
#
# Explicit exact(...) wrappers mark definitions independently of notebook
# syntax or literal handling; this module is loaded as ordinary Python.
