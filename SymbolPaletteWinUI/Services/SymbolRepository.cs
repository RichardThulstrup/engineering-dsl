    ...
    [
        ...
        new("Math", IconFile: "math.svg", Sections: [
            S("Constants & basic operators", [
                ...
                E("=", "math-style equality — a bool for numbers, a sympy Eq for symbols (solve(x² = 4, x))"),
            ]),
            S("Logic", [
        ...
        new("Symbolic", IconFile: "symbolic.svg", Sections: [
            ...
            S("Symbolic algebra", [
                ...
                E("solve(, )", "solve an equation or system — solve(x² = 4, x); a math-style = builds the equation"),
                E("solve([ = ,  = ], [, ])", "solve a system written with = : solve([x + y = 3, x − y = 1], [x, y])"),
                ...
                E("Eq()", "construct a symbolic equation explicitly; Eq(lhs, rhs)"),
