    ...
    [
        ...
        new("Math", IconFile: "math.svg", Sections: [
            S("Constants & basic operators", [
                ...
                E("≡", "symbolic equation — Eq(lhs, rhs); solve(x² ≡ 4, x)"),
                E("≟", "equality comparison — same as == in DSL (U+225F)"),
                E("＝", "fullwidth equals — same as == in DSL (U+FF1D)"),
                E("≈", "approximately equal — used for tolerant comparison"),
                E("≠", "not equal"),
                E("≤", "less than or equal"),
                E("≥", "greater than or equal"),
                E("=", "assignment in default DSL mode; use ≟, ＝ or == to compare, and ≡ or Eq(...) for symbolic equations"),
            ]),
            S("Logic", [
                E("∧", "logical and — DSL rewrites to Python 'and'"),
                E("∨", "logical or — rewrites to 'or'"),
                E("¬", "logical not — rewrites to 'not'"),
            ]),
            S("Powers, roots, exponents", [
                ...
                E("∛", "cube root glyph — same as ³√: ∛27 = 3"),
                E("∜", "fourth root glyph — same as ⁴√: ∜16 = 2"),
                E("sin⁻¹()", "inverse function via superscript — sin⁻¹(x) is asin(x); works for cos, tan, sinh, cosh, tanh too"),
            ]),
            S("Common math functions", [
                ...
                E("sinh()", "hyperbolic sine — also cosh(), tanh(), asinh(), acosh(), atanh()"),
                E("hypot(, )", "√(a² + b² + …) — unit-aware: hypot(3.0 m, 4.0 m) = 5.0 m"),
                E("cbrt()", "cube root — unit-aware: cbrt(8.0 m³) = 2.0 m"),
                E("sign()", "signum: −1, 0 or 1"),
                E("clamp(, , )", "clip into [lo, hi] — clamp(x, lo, hi), units allowed"),
                E("round(, )", "round(x, n) — works on DSL values and keeps the unit"),
            ]),
            S("Calculus", [
                E("∂(, )", "partial derivative — ∂(f, x) is diff(f, x)"),
                E("∫(, )", "indefinite integral — ∫(f, x) is integrate(f, x)"),
                E("∫(, (, , ))", "definite integral — ∫(f, (x, a, b))"),
                E("∑", "summation — Σ(iterable), also Σ(k² for 1 ≤ k ≤ n)"),
                E("∏", "product — Π(iterable)"),
            ]),
            S("Fractions", [
                E("½", "one half"),
                E("⅓", "one third"),
        ...
        new("Engineering", IconFile: "engineering.svg", Sections: [
            S("Operators & assignment", [
                ...
                E("∥", "parallel (U+2225) — accepted as an alias of ‖"),
                E("≔", "assignment glyph (U+2254) — same as :="),
            ]),
            S("Intervals (±) and phasors (∠)", [
                E("100 Ω ± 5%", "a % (or ‰) tolerance is RELATIVE to the centre — (95 Ω ‥ 105 Ω)"),
                E("‥", "closed interval from its ends — (95 ‥ 105) is what ± prints; pasteable"),
                E("▸ plusminus", "show an interval as centre ± half-width: 100 Ω ± 5 Ω"),
                E("▸ percent", "show an interval as centre ± tolerance in %: 100 Ω ± 5.00%"),
                E("▸ permille", "show an interval as centre ± tolerance in ‰"),
                E("approx(, , sf=True)", "≈ to the stated precision — equal when both round to the smaller sig-fig count"),
                E("5.0 ∠ 30°", "phasor literal — prints back as 5.0 ∠ 30°"),
                E("polar()", "display a complex value in polar form (magnitude ∠ angle°)"),
                E("rect()", "display a complex value in rectangular a+bj form"),
                E("▸ deg", "read an angle (radians) back in degrees: asin(0.5) ▸ deg = 30 deg"),
            ]),
            S("Vectors and tables", [
                E("‖‖", "norm — put the vector between the bars: ‖v‖ (unit-aware)"),
                E("norm()", "Euclidean norm of a list, [] N array or sympy vector"),
                E("dot(, )", "dot product, unit-aware: dot([1,2,3] N, [4,5,6] m) = 32 J"),
                E("cross(, )", "cross product of two 3-vectors, unit-aware"),
                E("interp(, , )", "table lookup — interp(x, xs, ys), linear, unit-aware; extrapolate=True continues the ends"),
            ]),
        ...
        new("Constants", IconFile: "constants.svg", Sections: [
            ...
            S("Fundamental physics", [
                ...
                E("m_n", "neutron mass ≈ 1.675 × 10⁻²⁷ kg"),
                E("Faraday", "Faraday constant = N_A · q_e ≈ 96 485 C/mol (F is the farad; F_c is an alias)"),
                E("α_fs", "fine-structure constant ≈ 7.297 × 10⁻³ (dimensionless; alpha_fs is an alias)"),
                E("a_0", "Bohr radius ≈ 52.92 pm"),
                E("μ_B", "Bohr magneton ≈ 9.274 × 10⁻²⁴ J/T"),
                E("Z_0", "impedance of free space ≈ 376.73 Ω (= μ_0·c)"),
                E("R_∞", "Rydberg constant ≈ 1.097 × 10⁷ /m (R_inf in Python)"),
                E("b_wien", "Wien displacement constant ≈ 2.898 × 10⁻³ m·K"),
            ]),
            ...
            S("Engineering reference values", [
                ...
                E("p_0", "standard atmosphere = 101 325 Pa (exact)"),
                E("20 °C", "room temperature as an absolute-temperature literal (293.15 K)"),
            ]),
        ]),
        ...
        // ===============================================================
        new("Symbolic", IconFile: "symbolic.svg", Sections: [
            S("Declarations", [
                E("symbols: ", "declare sympy symbols — symbols: x, y, R1..R4 (ranges expand; R₁ registers a subscripted name)"),
                E("positive_symbols: ", "declare symbols assumed positive"),
                E("real_symbols: ", "declare symbols assumed real"),
                E("integer_symbols: ", "declare symbols assumed integer"),
            ]),
            S("Symbolic algebra", [
                ...
                E("solve(, )", "solve an equation or system — solve(x² ≡ 4, x)"),
                E("solve([ ≡ ,  ≡ ], [, ])", "solve a system — solve([x + y ≡ 3, x − y ≡ 1], [x, y])"),
                E("nsolve(, , )", "numeric root — nsolve(expr, var, guess); DSL numbers accepted as the guess"),
                E("diff()", "symbolic derivative; diff(expr, variable) — or ∂(expr, x)"),
                E("integrate()", "symbolic integral; (expr, var) or (expr, (var, a, b)) — or ∫(expr, x)"),
                ...
                E("lambdify(, )", "turn an expression into a fast numeric function — lambdify(x, expr)"),
                E("latex()", "LaTeX source of an expression"),
                E("nsimplify()", "recover exact forms from floats (0.5 → 1/2)"),
                E("Eq()", "symbolic equation — Eq(lhs, rhs), also written lhs ≡ rhs"),
                E("sym.collect(, )", "collect terms by powers of a variable (sym. prefix — not re-exported)"),
                E("sym.trigsimp()", "simplify trigonometric expressions (sym. prefix)"),
                E("sym.expand_trig()", "expand trig functions of sums (sym. prefix)"),
                E("Symbol()", "declare a single sympy symbol; x = Symbol('x') (prefer symbols: x)"),
        ...
        new("Matrix", IconFile: "matrix.svg", Sections: [
            ...
            S("Operations", [
                ...
                E("M⁻¹", "inverse via the superscript — M⁻¹ is M.inv(); M² is M·M"),
                E("|M|", "determinant via bars — |M| is M.det() (norm for a row/column vector)"),
                E("det()", "determinant, function form"),
                E("eye()", "identity matrix — eye(3)"),
                E("zeros(, )", "zero matrix — zeros(rows, cols); also ones(, ), diag(, , )"),
            ]),
            S("Indexing (2-D)", [
        ...
        new("Plotting", IconFile: "plotting.svg", Sections: [
            S("Plot", [
                ...
                E("plot(, [ ± ,  ± ] )", "a series of ± values draws error bars: plot(x, [1.0 ± 0.1, 2.1 ± 0.2] V)"),
            ]),
            S("Axes options", [
                E("logx=True", "logarithmic x axis"),
                E("logy=True", "logarithmic y axis"),
                E("loglog=True", "both axes logarithmic"),
                E("grid=True", "draw a grid (minor lines too on a log axis)"),
                E("xlim=(, )", "x-axis limits — unit-carrying ends are fine: xlim=(1 Hz, 100 kHz)"),
                E("ylim=(, )", "y-axis limits"),
                E("figsize=(, )", "figure size in inches — figsize=(6, 3)"),
                E("save=\"\"", "also save the figure to a file — save=\"plot.png\""),
            ]),
            S("Bode", [
                E("bode(, , (, ))", "Bode plot — bode(H, p, (f_min, f_max)); p is the Laplace variable, replaced by j·2π·f (s is the second, use p)"),
                E("bode(, , (, ), s=False)", "sweep the variable itself as ω (for an expression written with an explicit i·ω)"),
            ]),
            S("Fitting", [
        ...
        new("Units", IconFile: "units.svg", Sections: [
            ...
            S("Writing a value (unit position)", [
                E("5 in", "in / min / h are the inch, minute and hour when they follow a number or a unit/ — elsewhere Python's in, min() and Planck's h"),
                E("90 km/h", "kilometres per hour — h after a unit/ is the hour"),
                E("20 L/min", "litres per minute — min after a unit/ is the minute"),
                E("3 h", "three hours (also 3 hr)"),
                E("lbf/in²", "pounds-force per square inch — the inch takes a superscript"),
                E("2500 mAh", "every unit exported by extra_units binds tightly to a preceding number"),
            ]),
            S("Mass", [
                E("▸ mg", "milligrams"),
                E("▸ g", "grams"),
                E("▸ kg", "kilograms"),
                E("▸ tonne", "metric tonnes (1000 kg) — the symbol t is left free for time"),
            ...
            S("Force", [
                ...
                E("▸ kip", "kilopound-force (1000 lbf, structural)"),
            ]),
            ...
            S("Pressure", [
                E("▸ μPa", "micropascals (acoustics; 20 μPa reference)"),
                E("▸ Pa", "pascals"),
                E("▸ kPa", "kilopascals"),
                E("▸ MPa", "megapascals"),
                E("▸ GPa", "gigapascals (elastic moduli)"),
                E("▸ mbar", "millibars"),
                E("▸ bar", "bars (= 100 kPa exactly)"),
                E("▸ atm", "atmospheres (= 101.325 kPa exactly)"),
                E("▸ torr", "torr (= 1/760 atm)"),
                E("▸ mmHg", "millimetres of mercury (medical / barometric)"),
                E("▸ psi", "pounds per square inch"),
                E("▸ ksi", "kilopounds per square inch"),
            ]),
            S("Energy", [
                E("▸ mJ", "millijoules (μJ, nJ, pJ too)"),
                E("▸ J", "joules"),
                E("▸ kJ", "kilojoules"),
                E("▸ MJ", "megajoules"),
                E("▸ Wh", "watt-hours"),
                E("▸ kWh", "kilowatt-hours"),
                E("▸ MWh", "megawatt-hours (GWh too)"),
                E("▸ eV", "electronvolts"),
                E("▸ MeV", "megaelectronvolts (keV, GeV, TeV too)"),
            ...
            S("Power", [
                ...
                E("▸ kW", "kilowatts"),
                E("▸ MW", "megawatts"),
                E("▸ VA", "volt-amperes — apparent power, keeps the written form (kVA, MVA too)"),
                E("▸ var", "volt-amperes reactive (kvar, Mvar too)"),
            ...
            S("Time", [
                ...
                E("▸ ms", "milliseconds"),
                E("▸ s", "seconds"),
                E("▸ min", "minutes — min is the minute as a ▸ target and in unit position"),
                E("▸ minute", "minutes (= 60 s)"),
                E("▸ h", "hours — h is the hour as a ▸ target and in unit position"),
                E("▸ hr", "hours — the short unambiguous spelling"),
                E("▸ hour", "hours (= 3600 s)"),
                E("▸ day", "days (= 86 400 s)"),
                E("▸ week", "weeks (= 7 days)"),
            ...
            S("Frequency", [
                ...
                E("▸ MHz", "megahertz"),
                E("▸ GHz", "gigahertz"),
                E("▸ rps", "revolutions per second"),
                E("▸ rpm", "revolutions per minute — a frequency: 3000 rpm ▸ Hz = 50 Hz"),
            ]),
            S("Angle", [
                E("▸ deg", "degrees — asin(0.5) ▸ deg = 30 deg"),
                E("▸ rad", "radians (the number itself)"),
                E("▸ rev", "revolutions (turns)"),
                E("▸ arcmin", "arc minutes (arcsec too)"),
                E("30°", "angle literal — 30·π/180 radians"),
                E("30 deg", "the same angle with the unit name"),
                E("1.5 rad", "radians are the plain number 1"),
                E("2π · n", "angular velocity from a rotational frequency n (rpm/rps)"),
            ]),
            S("Speed", [
                E("▸ mph", "miles per hour"),
                E("▸ kph", "kilometres per hour"),
                E("▸ knot", "knots (= 1.852 km/h)"),
                E("▸ m/s", "metres per second"),
            ]),
            S("Electrical", [
                E("▸ mV", "millivolts (μV, nV too)"),
                E("▸ V", "volts"),
                E("▸ kV", "kilovolts"),
                E("▸ μA", "microamperes (nA, pA too)"),
                E("▸ mA", "milliamperes"),
                E("▸ A", "amperes"),
                E("▸ kA", "kiloamperes"),
                E("▸ Ω", "ohms"),
                E("▸ kΩ", "kilohms (mΩ, MΩ, GΩ too)"),
                E("▸ mS", "millisiemens — conductance (μS, kS, siemens too)"),
                ...
                E("▸ μF", "microfarads"),
                E("▸ mF", "millifarads"),
                E("▸ mH", "millihenries (μH, nH too)"),
                E("▸ Ah", "ampere-hours — charge capacity"),
                E("▸ mAh", "milliampere-hours (battery datasheets)"),
                E("▸ mT", "millitesla (μT, nT too)"),
                E("▸ T", "tesla — magnetic flux density"),
                E("▸ gauss", "gauss (CGS, 0.1 mT)"),
                E("▸ Wb", "weber — magnetic flux"),
            ]),
            S("Volume and area", [
                E("▸ mL", "millilitres"),
            ...
            S("Process, light, radiation", [
                E("▸ cP", "centipoise — dynamic viscosity (Pa_s, poise too)"),
                E("▸ cSt", "centistokes — kinematic viscosity"),
                E("▸ mmol", "millimoles (μmol, kmol too)"),
                E("▸ lx", "lux — illuminance"),
                E("▸ lm", "lumens — luminous flux"),
                E("▸ Bq", "becquerel — activity (kBq, MBq, Ci too)"),
                E("▸ mSv", "millisievert — dose equivalent (Sv, μSv too)"),
            ]),
            S("Temperature", [
        ...
        new("Various", IconFile: "various.svg", Sections: [
            ...
            S("Built-ins", [
                ...
                E("round(, )", "round(x, n) — works on DSL values and keeps the unit: round(1.2345 V, 2) = 1.23 V"),
            ...
            S("Date / time — durations", [
                E("\"PT90M\"ₜᵢₘₑ ▸ hour", "a timedelta read in a time unit — 1.5 hour"),
                E("\"-PT5M\"ₜᵢₘₑ", "signed durations parse; fractional too (\"PT1.5H\")"),
                E("iso()", "parse or format ISO 8601 — whole years/months/weeks round-trip (P1Y)"),
            ]),
